...
class Orm extends Connect_mysql{
    ...
    public function model($model){
        switch($model){
            case 'select':return new SELECT($this->mysql_conn);
                break;
            case 'insert':return new INSERT($this->mysql_conn);
                break;
            case 'delete':return new DELETE($this->mysql_conn);
                break;
            case 'update':return new UPDATE($this->mysql_conn);
                break;
        }
    }
}
